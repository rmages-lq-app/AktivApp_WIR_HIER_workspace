...
import 'package:aktiv_app_flutter/Views/profile/app_version.dart';
...
class _BodyState extends State<Body> {
  ...
  //Anzeigen der Rolle, sofern angegeben
  Text buildRolle() {
    if (Provider.of<UserProvider>(context, listen: false).rolle != null &&
        Provider.of<UserProvider>(context, listen: false).rolle != "null" &&
        Provider.of<UserProvider>(context, listen: false).rolle != null &&
        Provider.of<UserProvider>(context, listen: false).rolle != "null" &&
        UserProvider.istEingeloggt) {
      return Text(
        Provider.of<UserProvider>(context, listen: false).rolle,
        style: TextStyle(
            fontSize: 18.0,
            color: ColorPalette.torea_bay.rgb,
            letterSpacing: 2.0,
